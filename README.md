...
This repository contains reproductions of data race and synchronization bugs
found in the TileLang GPU kernel compiler.

## Bugs

| Issue | Title | Bug Type | Status |
|-------|-------|----------|--------|
| [#1257](issue_1257_missing_syncthreads/) | Missing `__syncthreads()` after `AtomicAdd` | Data race in generated CUDA kernel | Fixed in v0.1.8 |
